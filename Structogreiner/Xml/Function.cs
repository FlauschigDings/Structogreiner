...
namespace Structogreiner.Xml
{
    ...
    internal class Function : XmlWriter
    {
        ...
        public Function(string title, string author, List<VariableDeclaration> variables, List<VariableDeclaration> parameters, Type? returnType = null, MethodType type = MethodType.Main, string comment = "created by Structogreiner") : base("root")
        {
